...
class IOCForm(FlaskForm):
    ...
    iocType = SelectField('Type',choices=[('attachmentname','Attachment name'),
                                          ...
                                          ('bodysendertopleveldomain','Body Sender TLD'),
                                          ('envelopesenderdomain','Envelope sender domain'),
                                          ('envelopesenderemail','Envelope sender email '),
                                          ('envelopesendertopleveldomain','Envelope sender TLD'),
                                          ...
                                          ('subject','Subject'),
                                          ('url','URL')
                                          ],default='subject',validators=[DataRequired()])
    iocValue = StringField('Value', validators=[DataRequired()],render_kw={"placeholder": "IOC Value"})
    description = StringField('Description', validators=[DataRequired()],render_kw={"placeholder": "Description"})
    emailDirection = SelectField('Email direction',choices=[('I','Inbound'),('O','Outbound'),('B','Both')],default='B', validators=[DataRequired()])
    remediationAction = SelectField('Remediation action',choices=[('B','Block and Delete'),
                                                                  ('Q','Quarantine'),
                                                                  ('M','Redirect'),
                                                                  ('T','Tag subject'),
                                                                  ('H','Append header')],default='B', validators=[DataRequired()])
